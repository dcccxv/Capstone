...
/*
        ...
        mDatabase.child("locations").child(loginID).child("name").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                // Get Post object and use the values to update the UI
                if(dataSnapshot.getValue(String.class) != null){
                    String post = dataSnapshot.getValue(String.class);
                    editStoreName.setText(post);
                }
            }
            @Override
        ...
        mDatabase.child("locations").child(loginID).child("seat").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                // Get Post object and use the values to update the UI
                if(dataSnapshot.getValue(int.class) != null){
                    String post = dataSnapshot.getValue(int.class).toString();
                    editSeats.setText(post);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
        ...
        editStoreName.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable arg0) {
                ...
                taskMap.put("locations/"+loginID+"/name", arg0.toString());
    ...
    public SurfaceHolder.Callback surfaceListener = new SurfaceHolder.Callback()
    {
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height)
        {
            ...
            for (int i = 0; i < previewSizes.size(); i++) {
                if ((previewSizes.get(i).width/4 == previewSizes.get(i).height/3)) {
                    size = previewSizes.get(i);
                    break;
                }
            }
            parameters.setPreviewSize(size.width, size.height);
            //Toast.makeText(MainActivity.this, size.width + " "+ size.height, Toast.LENGTH_SHORT).show();
